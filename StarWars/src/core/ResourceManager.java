...
//			IMAGE_CACHE.put(fileName, new ImageIcon(ResourceManager.class.getResource("/images/"+fileName)).getImage()); //错误
			IMAGE_CACHE.put(fileName, new ImageIcon("D:/Eclipse/LearningSpace/StarWars/res/images/"+fileName).getImage());
		} 
